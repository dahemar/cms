...
app.put("/posts/:id", adminRateLimiter, resolveSiteFromDomain, requireAuth, async (req, res) => {
  try {
    ...
    // Registrar en auditoría (hacerlo antes de enviar la respuesta para evitar errores no manejados)
    try {
      ...
      console.error("[Backend PUT /posts/:id] ERROR in audit log (non-critical):", auditErr);
    }
