...
app.post("/admin/update-sites-and-user", adminRateLimiter, requireAuth, async (req, res) => {
  try {
    ...
    console.log("[POST /admin/update-sites-and-user] Executing update script...");
    ...
    console.error("[POST /admin/update-sites-and-user] ERROR:", err);
